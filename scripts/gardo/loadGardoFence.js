var loadGardoFence = (
  ...
  BABYLON.SceneLoader.ImportMeshAsync(
    "",
    "mesh/",
    // "http://zaunplaner.mega-holz.de/fence-configurator-assets/easy-fence/mesh/",
    "gardoRightCombo2.glb"
  ).then((result) => {
    ...
    rankelement.material = woodMaterials[0];
    ...
    woodTopPart.material = woodMaterials[0];
